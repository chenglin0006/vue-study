...
const devWebpackConfig = merge(baseWebpackConfig, {
  module: {
    rules: utils.styleLoaders({ sourceMap: config.development.cssSourceMap, usePostCSS: true })
  },
  ...
  devServer: {
    ...
    historyApiFallback: {
      rewrites: [
        { from: /.*/, to: path.posix.join(config.development.assetsPublicPath, 'index.html') },
      ],
    },
    hot: true,
